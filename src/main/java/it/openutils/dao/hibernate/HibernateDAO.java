...
public interface HibernateDAO<T, K extends Serializable>
{
     ...
     */
    @Deprecated
    List<T> findFiltered(T filter, Map<String, FilterMetadata> metadata);
     ...
     */
    @Deprecated
    List<T> findFiltered(T filter, Map<String, FilterMetadata> metadata, int maxResults, int page);
     ...
     */
    @Deprecated
    List<T> findFiltered(T filter, Map<String, FilterMetadata> metadata, int maxResults, int page, Order... orders);
     ...
     */
    T findFilteredFirst(T filter, List<Criterion> criteria);
     ...
     */
    @Deprecated
    List<T> findAll(Order[] orderProperties, List<Criterion> criteria);
     ...
     */
    @Deprecated
    List<T> findFiltered(T filter, Order[] orders, Map<String, FilterMetadata> metadata, int maxResults, int page);
     ...
     */
    @Deprecated
    List<?> findFilteredProperties(T filter, Order[] orders, Map<String, FilterMetadata> metadata, int maxResults,
        int page, List<Criterion> criteria, List<String> properties);
